...
Before installation of the 'Group4' package, ensure the proper libraries are active to download the GitHub repository. Include the below code:

```{r}
library(devtools)
library(repo)
install_github('AU-R-Programming/FinalProject_Group4')
```
...
This workflow provides a foundation to experiment with custom logistic regression implementations and gain more transparent insight into model performance.
